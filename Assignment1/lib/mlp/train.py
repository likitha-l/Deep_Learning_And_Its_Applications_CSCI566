...
def train_net(data, model, loss_func, optimizer, batch_size, max_epochs,
    ...
    for epoch in range(max_epochs):
        ...
        for iter in range(iter_start, iter_end):
            ...
            #############################################################################
            pass
            loss_hist.append(loss_func.forward(model.forward(data_batch),labels_batch))
        ...
        val_acc=compute_acc(model, data_val, labels_val, num_samples=None, batch_size=batch_size)
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
