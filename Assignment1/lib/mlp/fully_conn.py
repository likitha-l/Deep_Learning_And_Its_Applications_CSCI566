...
class TestFCReLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(flatten(name="flatten_test"),fc(20, 10, init_scale=0.02, name="fc_test"),relu(name="relu_f")
            ########## TODO: ##########
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(fc(4, 30, init_scale=0.02, name="fc_test1"),relu(name="relu_f1"),fc(30, 7, init_scale=0.02, name="fc_test2"),relu(name="relu_f2"),
            ########## TODO: ##########
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        """ Some comments """
        self.net = sequential(flatten(name="flatten"),fc(3072,500, init_scale=0.02, name="fc_1"),relu(name="relu"),fc(500, 10, init_scale=0.02, name="fc_2")
            ########## TODO: ##########
